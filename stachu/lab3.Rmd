...
Thus, the mean response for Program 1 decreases over time. For the second program it is exactly the same - in this case for every time point `r coefs[4]` is added to the expected respons, because in our model we don't include any interactions and the group effect is incorporated just by adding a constant.
