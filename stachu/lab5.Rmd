...
For this model we can see that included interactions yielded very small coefficients comapred to main effects. Therefore, it is reasonable to fit a model without interactions.
...
* As expected by looking at Table 1., the random effect is almost neglectable: $Var(b) = 0.0032$ and this means that values of $b$ for each observation are very small comapred to other variables multiplied by proper betas
