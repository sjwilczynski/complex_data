...
### step two
kidney.int <- lm(intercept~donor.age+bpl.drugs+factor(therapy), data = coef.kidney)
kidney.slp <- lm(slope~donor.age+bpl.drugs+factor(therapy), data = coef.kidney)
kidney.quadr.slp <- lm(quadr.slope~donor.age+bpl.drugs+factor(therapy), data = coef.kidney)


info.int <- round(summary(kidney.int)$coefficients[,c(1,2)], 4)
info.int
info.slp <- round(summary(kidney.slp)$coefficients[,c(1,2)], 4)
info.quadr <-round(summary(kidney.quadr.slp)$coefficients[,c(1,2)], 4)

summary(kidney.int)
```

```{r}
growth.model <- lme(MDRD~(ltime + I(ltime^2))*(donor.age + therapy +  bpl.drugs)  , random =~ltime + I(ltime^2)|factor(id), data = lkidney)
info.mixed <- round(summary(growth.model)$tTable[,c(1,2)], 4)
...
<!--  logTime*donor.age & $`r info.slp[2,1]` (`r info.slp[2,2]`)$ & $`r info.mixed[4,1]` (`r info.mixed[4,2]`)$ \\ -->
<!--      logTime*therapy.cm & $`r info.slp[2,1]` (`r info.slp[2,2]`)$ & $`r info.mixed[4,1]` (`r info.mixed[4,2]`)$ \\ -->
<!--     logTime*therapy.tc & $`r info.slp[2,1]` (`r info.slp[2,2]`)$ & $`r info.mixed[4,1]` (`r info.mixed[4,2]`)$ \\ -->
<!--        logTime*bpl.drugs & $`r info.slp[2,1]` (`r info.slp[2,2]`)$ & $`r info.mixed[4,1]` (`r info.mixed[4,2]`)$ \\   -->
<!--   logTime^2*donor.age & $`r info.slp[2,1]` (`r info.slp[2,2]`)$ & $`r info.mixed[4,1]` (`r info.mixed[4,2]`)$ \\ -->
<!--      logTime^2*therapy.cm & $`r info.slp[2,1]` (`r info.slp[2,2]`)$ & $`r info.mixed[4,1]` (`r info.mixed[4,2]`)$ \\ -->
<!--     logTime^2*therapy.tc & $`r info.slp[2,1]` (`r info.slp[2,2]`)$ & $`r info.mixed[4,1]` (`r info.mixed[4,2]`)$ \\ -->
<!--        logTime^2*bpl.drugs & $`r info.slp[2,1]` (`r info.slp[2,2]`)$ & $`r info.mixed[4,1]` (`r info.mixed[4,2]`)$ \\          -->